    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
          ...
          <li className={ this.isPathActive('/driver') ? 'nav-item active' : 'nav-item' }>
          ...
          <li className={ this.isPathActive('/assistant') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/assistant">
              <i className="mdi mdi-television menu-icon"></i>
              <span className="menu-title"><Trans>Assistant</Trans></span>
            </Link>
          </li>

          <li className={ this.isPathActive('/truck') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/truck">
              <i className="mdi mdi-television menu-icon"></i>
              <span className="menu-title"><Trans>Truck</Trans></span>
            </Link>
          </li>

          <li className={ this.isPathActive('/orders') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/orders">Dashboard
              <i className="mdi mdi-television menu-icon"></i>
              <span className="menu-title"><Trans>Orders</Trans></span>
            </Link>
          </li>

          <li className={ this.isPathActive('/delivery') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/delivery">
              <i className="mdi mdi-television menu-icon"></i>
              <span className="menu-title"><Trans>Delivery</Trans></span>
            </Link>
          </li>

          <li className={ this.isPathActive('/route') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/route">
              <i className="mdi mdi-television menu-icon"></i>
              <span className="menu-title"><Trans>Route</Trans></span>
            </Link>
          </li>
